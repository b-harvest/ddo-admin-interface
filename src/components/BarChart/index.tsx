import { DARK_CRE } from 'constants/style'
...
export default function BarChart({
  ...
  return (
    <div className="w-full p-4 pr-8 flex flex-col" style={{ minHeight }} {...rest}>
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          <XAxis
            ...
            axisLine={false}
            tickLine={false}
            tickFormatter={(time) => dayjs(time).format(activeWindow === TimeTick.Monthly ? 'MMM' : 'DD')}
            minTickGap={10}
          />
          <Tooltip
            cursor={{ fill: DARK_CRE }}
            ...
            formatter={(
              ...
              if (setLabel && label !== formattedTime) {
                if (activeWindow === TimeTick.Weekly) {
                ...
                } else if (activeWindow === TimeTick.Monthly) {
